...
app.get(['/:language(en|ru|mn)'], m.logMiddleware, index_handler)
app.get('/status', status)
app.get(['/dashboard/:language(en|ru|mn)'], m.logMiddleware, dashboard_handler)
app.get("/structure/:language(en|ru|mn)", m.logMiddleware, structure_handler)
app.get(["/login", '/login/:language(en|ru|mn)'], login_handler)
app.get(["/register", '/register/:language(en|ru|mn)/'], register_handler)
...
app.get("/lang/:language(en|ru|mn)", m.logMiddleware, change_lang_handler)
